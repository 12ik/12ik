...
<br/>
<p class="pl">本页永久链接: <a href="<?php echo SITE_URL;?><?php echo tsurl('user','space',array('id'=>$strUser['userid']))?>"><?php echo SITE_URL;?><?php echo tsurl('user','space',array('id'=>$strUser['userid']))?></a></p>
<br>
