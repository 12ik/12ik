...
<dl class="obu"><dt><a class="nbg" href="<?php echo SITE_URL;?><?php echo ikurl('user','space',array('id'=>$item['userid']))?>"><img alt="<?php echo $item['username'];?>" class="m_sub_img" src="<?php echo $item['face'];?>"></a></dt>
<dd><a href="<?php echo SITE_URL;?><?php echo ikurl('user','space',array('id'=>$item['userid']))?>"><?php echo $item['username'];?></a></dd>
</dl>
<?php }?>
...
<br/>
<p class="pl">本页永久链接: <a href="<?php echo SITE_URL;?><?php echo ikurl('user','space',array('id'=>$strUser['userid']))?>"><?php echo SITE_URL;?><?php echo ikurl('user','space',array('id'=>$strUser['userid']))?></a></p>
<br>
