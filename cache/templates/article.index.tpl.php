		...
		<aside class="w190 fl">
			<section class="categories">
				...
				<ul class="list categories-list">
					...
					<li><a href="<?php echo SITE_URL;?><?php echo tsurl('article','list',array('cateid'=>$item['catid']))?>"><?php echo $item['name'];?></a></li>
					<!--         <?php } ?>   -->
				</ul>
			</section>
			<section class="personal-publish">
				...
				<div class="bd">
					...
					<p class="entrance">
						<a href="#" class="btn btn-large">去投稿<i
				...
				<div class="bd">
					<ul class="list-lined article-list">
						...
						<li class="item" id="article-407582">
							<div class="title">
								<a href="<?php echo SITE_URL;?><?php echo tsurl('article','show',array('id'=>$item['news'][nid]))?>"><?php echo $item['subject'];?> 
                                <?php if($item['attach']) { ?>
                                [图文]
                                <?php } ?>
                                </a>
                            ...
                            <?php if($item['attach']) { ?> 
							<div class="cover">
                                <a class="pic" href="<?php echo SITE_URL;?><?php echo tsurl('article','show',array('id'=>$item['news'][nid]))?>">
									<img src="<?php echo ATT_URL;?><?php echo $item['attach'][thumbpath];?>" />
								</a> 
							</div>
                            <?php } ?>                            
							<div class="info">
