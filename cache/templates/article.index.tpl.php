		...
		<aside class="w190 fl">
			<section class="categories">
				...
				<ul class="list categories-list">
					...
					<li><a href="<?php echo U('article','list',array('cateid'=>$item['catid']))?>"><?php echo $item['name'];?></a></li>
					<!--         <?php } ?>   -->
				</ul>
			</section>
			<section class="personal-publish">
				...
				<div class="bd">
					...
					<p class="entrance">
						<a href="<?php echo U('article','do',array('ik'=>'post'))?>" class="btn btn-large">去投稿<i class="arrow-right"></i></a>
					</p>
				</div>
			</section>
		</aside>
				...
				<div class="bd">
					<ul class="list-lined article-list">
						...
						<li class="item" id="article-407582">
                            ...
                            <?php if($item['attach']) { ?> 
							<div class="cover">
                                <a class="pic" href="<?php echo U('article','show',array('id'=>$item['news'][nid]))?>">
							...
							<div class="info">
								<div class="article-desc-brief">
									<?php echo getsubstrutf8(t($item['news'][message]),0,150);?>...<a
										href="<?php echo U('article','show',array('id'=>$item['news'][nid]))?>">（更多）</a>
								</div>
							</div>
