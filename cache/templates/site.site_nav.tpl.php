<div id="header">
       <div class="top-nav">
            ...
            <div class="top-nav-info">
                ...
                <?php } else { ?>
                <a id="newmsg" href="<?php echo SITE_URL;?><?php echo ikurl('message','ikmail',array(ik=>inbox))?>">新消息</em></a>
                <a href="<?php echo SITE_URL;?><?php echo ikurl('user','set',array(ik=>base))?>" target="_blank"><?php echo $IK_USER['user'][username];?>的帐号</a>
...
<div class="sp-logo">
    <a class="logo" 
    href="<?php echo SITE_URL;?><?php echo ikurl('site','mine',array('siteid'=>$strSite['siteid']))?>" 
...
<li <?php if($item['roomid'] == $roomid) { ?> class="on" <?php } ?>>
    <a hidefocus="true" href="<?php echo SITE_URL;?><?php echo ikurl('site','room',array('siteid'=>$strSite['siteid'],'roomid'=>$item['roomid']))?>" roomid="<?php echo $item['roomid'];?>">
...
<li class="opt" id="room-admin">
	<a href="<?php echo SITE_URL;?><?php echo ikurl('site','admins',array('siteid'=>$strSite['siteid']))?>" id="admin-icon" title="管理小站">管理小站</a>
...
<?php if($roomid>0 && $strSite['userid'] == $IK_USER['user'][userid]) { ?>   
    <div class="sp-fn-box">
        ...
        <div id="widget-normal" class="widgets-box">
