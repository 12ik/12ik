...
<div class="midder">
	<div class="mc">
    	...
    	<div class="cleft">
            ...
            <div class="clear"></div>
		 <form  method="post" onSubmit="return isConfirmed" action="<?php echo U('message','do',array('ik'=>'all'))?>">               <table class="olt">
              <tbody>
                <tr>
                ...
                <tr>
                  ...
                  <a onClick="return confirm('真的要删除消息吗？')" class="post_link" href="<?php echo U('message','do',array('ik'=>'del','type'=>'outbox','messageid'=>$item['messageid']))?>">删除</a>
                  </td>
                </tr>
                <?php }?>
                <tr>
