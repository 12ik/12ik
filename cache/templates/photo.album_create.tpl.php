...
<div class="midder">
  ...
  <div class="mc">
	...
	<div class="cleft">
        ...
        <form method="POST" action="<?php echo SITE_URL;?>index.php?app=photo&ac=album&ts=create_do">
  <table width="100%" cellpadding="0" cellspacing="0" class="table_1">
           ...
           <tr>
           		<th></th>
                <td>
                <input class="submit" type="submit" value="创建相册" />  <a href="<?php echo SITE_URL;?><?php echo tsurl('photo','album',array(ts=>user,userid=>$userid))?>">返回我的相册</a></td>
           </tr> 
     </table>
        </form>
	</div>
