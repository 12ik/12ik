...
<div>
<form method="POST" action="index.php?app=system&ac=urltype&ik=do">

<table>
	<tr>
		<td width="100">形式1：</td>
		<td><input type="radio" <?php if($IK_SITE['base'][site_urltype]==1) { ?> checked="select" <?php } ?>
		name="site_urltype" value="1" /> index.php?app=group&ac=topic&id=1</td>
	</tr>
	<tr>
		<td>形式2：</td>
...
<div class="clear"></div>
<br />
<input type="submit" value="更改链接形式" /></form>
