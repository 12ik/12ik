...
<span>
<a class="j a_confirm_link" href="<?php echo SITE_URL;?>index.php?app=article&ac=comment&ts=delete&commentid=<?php echo $item['commentid'];?>" rel="nofollow" onclick="return confirm('确定删除?')">删除</a>
</span>
<?php } ?>
</div>
...
<form method="POST" action="<?php echo SITE_URL;?><?php echo tsurl('article','comment',array('ts'=>'add'))?>" onSubmit="return checkComment('#formMini');" id="formMini">
