...
<form method="POST" action="<?php echo SITE_URL;?>index.php?app=group&a=topic_edit&ik=do">
<table cellpadding="0" cellspacing="0" class="table_1">
    ...
    <input type="submit" class="submit" value="保存">&nbsp;&nbsp;<a href="<?php echo U('group','topic',array('id'=>$strTopic['topicid']))?>">返回</a>
	</td>
    </tr>
</table>
