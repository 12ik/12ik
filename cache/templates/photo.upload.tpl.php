...
<script type="text/javascript">
    var loadurl = "<?php echo SITE_URL;?><?php echo tsurl('photo','do',array('ts'=>'flash',albumid=>$albumid))?>";
	var objdata = {'userid': '<?php echo $IK_USER['user'][userid];?>','albumid': '<?php echo $albumid;?>'};
	var jumpurl = "<?php echo SITE_URL;?><?php echo tsurl('photo','album',array('ts'=>'info',albumid=>$albumid,'addtime'=>$addtime))?>";
...
<div class="mc">
    ...
    <div class="cright">
        ...
        <br><br>
        <p class="pl2">&gt; <a href="<?php echo SITE_URL;?><?php echo tsurl('photo','album',array(ts=>photo,albumid=>$strAlbum['albumid']))?>">回相册"<?php echo $strAlbum['albumname'];?>"</a></p>
    </div>
