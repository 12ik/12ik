...
<div class="user_left">
<form method="POST" action="<?php echo SITE_URL;?><?php echo ikurl('user','login',array('ik'=>'do'))?>" id="signupform">
...
&nbsp;&nbsp;<a href="<?php echo SITE_URL;?><?php echo ikurl('user','register')?>">还没有帐号？</a> | <a href="<?php echo SITE_URL;?><?php echo ikurl('user','forgetpwd')?>">忘记密码</a>
</td>
</tr>
</table>
</form>
