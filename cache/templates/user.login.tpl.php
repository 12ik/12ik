...
<div class="user_left">
<form method="POST" action="<?php echo SITE_URL;?><?php echo tsurl('user','login',array('ts'=>'do'))?>" id="signupform">
...
&nbsp;&nbsp;<a href="<?php echo SITE_URL;?><?php echo tsurl('user','register')?>">还没有帐号？</a> | <a href="<?php echo SITE_URL;?><?php echo tsurl('user','forgetpwd')?>">忘记密码</a>
</td>
</tr>
</table>
</form>
