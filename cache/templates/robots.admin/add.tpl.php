...
{	
	var addurl = '<?php echo SITE_URL;?>index.php?app=robots&a=admin&mg=add&ik=do';
	obj = $(obj);
	if($('#name').val()=='')
	{
...
function debugsubmit(obj, nodename, process) {
	...
	//跳转地址
	$('#theform').attr('action','<?php echo SITE_URL;?>index.php?app=robots&a=admin&mg=add&ik=debug');	
