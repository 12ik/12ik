    ...
    <div class="cleft">
		<div class="tags-nav">
            <ul class="tags">
              ...
              <li><a class="active" href="<?php echo U('site','explore',array('ik'=>'site'))?>">全部</a></li>
        ...
        <div class="site-loading" style="display: none;"><span class="state">加载中</span></div>
            ...
            <ul class="site-list" style="display: block;">
                ...
                <li class="site-item">
                <div class="pic">
                    <a target="_blank" href="<?php echo U('site','mine',array('siteid'=>$item['siteid']))?>" title="<?php echo $item['sitename'];?>">
                        <img width="75" height="75" alt="<?php echo $item['sitename'];?>" src="<?php echo $item['icon_75'];?>">
                    </a>
                </div>
                <div class="info">
                  <div class="title">
                    <a target="_blank" href="<?php echo U('site','mine',array('siteid'=>$item['siteid']))?>" title="<?php echo $item['sitename'];?>"><?php echo $item['sitename'];?></a>
                  </div>
