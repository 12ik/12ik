...
<div class="midder">
	...
	<?php } ?>
                    ...
                    <?php foreach((array)$arrGroup as $key=>$item) {?>
                            <div class="sub-item">
                                    ...
                                    <div class="pic">
                                        ...
                                        <?php } else { ?>
                                        <a class="joingroup" href="<?php echo SITE_URL;?><?php echo tsurl('group','do',array('ts'=>'join','groupid'=>$item['groupid']))?>">+加入</a>
                                        <?php } ?>
                                        
                                    </div>
                                    <div class="info">
                                            <div class="title">
                                                <a href="<?php echo SITE_URL;?><?php echo tsurl('group','show',array('id'=>$item['groupid']))?>" title="<?php echo $item['groupname'];?>" target="_blank"><?php echo $item['groupname'];?></a>
        ...
        <div class="cright">
                ...
                <a href="<?php echo SITE_URL;?><?php echo tsurl('group','topic',array('id'=>$item['topicid']))?>"><?php echo $item['title'];?></a> (<?php echo $item['count_comment'];?>)
                <br />
                <?php }?>
                </div>
