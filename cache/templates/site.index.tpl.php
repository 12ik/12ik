  ...
  <?php foreach((array)$strMylikeSite as $item) {?>
    <li class="tl-item">
        ...
        <div class="item-title site-title">
            ...
            <a target="_blank" href="<?php echo U('site','mine',array('siteid'=>$item['siteid']))?>" class="icon">
                <img width="32" height="32" src="<?php echo $item['icon_48'];?>">
            </a>
            <div class="info">
                <a target="_blank" href="<?php echo U('site','mine',array('siteid'=>$item['siteid']))?>"><?php echo $item['sitename'];?></a>
            </div>
        </div>
        ...
        <div class="site-item first">
            <div class="title">
                ...
                <a href="<?php echo U('site','notes',array('notesid'=>$itemnotes['notesid'],'noteid'=>$itemnotes['contentid']))?>" target="_blank"><?php echo $itemnotes['title'];?></a>
            </div>
            <div class="content">
            	<?php if($itemnotes['photo']) { ?>
                    <a href="<?php echo U('site','notes',array('notesid'=>$itemnotes['notesid'],'noteid'=>$itemnotes['contentid']))?>" class="note-image" target="_blank">
    ...
    <?php } ?>
        ...
        <div class="footer">
            ...
            <a href="<?php echo U('site','explore',array('ik'=>'site'))?>">发现更多小站</a>
        </div>
...
<div class="component groups-sites">
    <h2>
        我喜欢的小站
            &nbsp;·&nbsp;·&nbsp;·&nbsp;·&nbsp;·&nbsp;·
            <span class="pl">&nbsp;(
                     <a href="<?php echo U('site','people',array('ik'=>'minisite'))?>">全部</a>
                ) </span>
    </h2>

    <div class="content">
            <?php foreach((array)$strMylikeSite as $item) {?>
            <a class="show-title" title="<?php echo $item['sitename'];?>" href="<?php echo U('site','mine',array('siteid'=>$item['siteid']))?>"><img width="38" height="38" alt="<?php echo $item['sitename'];?>" src="<?php echo $item['icon_48'];?>"></a>
            <?php } ?>
...
<div class="component groups-sites">
    ...
    <div class="content">
            ...
            <p class="pl2">&gt; <a href="<?php echo U('site','explore',array('ik'=>'site'))?>">发现更多小站</a></p>
            <p class="pl2">&gt; <a href="<?php echo U('site','new_site')?>">申请创建小站</a></p>
