            ...
            <div id="db-timeline-hd">
                <ul class="menu-list">
                    <li <?php if($ik=="inbox") { ?> class="on" <?php } ?>>
                        <a href="<?php echo SITE_URL;?><?php echo ikurl('message','ikmail',array('ik'=>'inbox'))?>">
                            所有消息
                        </a>
                    </li>
                    <li <?php if($ik=="unread") { ?> class="on" <?php } ?> >
                        <a href="<?php echo SITE_URL;?><?php echo ikurl('message','ikmail',array('ik'=>'unread'))?>">
                            未读消息(<?php echo $unreadnum;?>)
                        </a>
                    </li>
                    <li <?php if($ik=="spam") { ?> class="on" <?php } ?> >
                        <a href="<?php echo SITE_URL;?><?php echo ikurl('message','ikmail',array('ik'=>'spam'))?>">
                            垃圾消息(<?php echo $spamnum;?>)
                        </a>
                    </li>
                </ul>
            </div>  
		 <form  method="post" onSubmit="return isConfirmed" action="<?php echo SITE_URL;?><?php echo ikurl('message','do',array('ik'=>'all'))?>">            
            <table class="olt">
              <tbody>
                <tr>
                ...
                <tr>
                  ...
                  <?php if($ik!="spam") { ?><a rel="direct" class="post_link" href="<?php echo SITE_URL;?><?php echo ikurl('message','do',array('ik'=>'spam','messageid'=>$item['messageid']))?>">垃圾消息</a><?php } ?>
                  <a onClick="return confirm('真的要删除消息吗？')" class="post_link" href="<?php echo SITE_URL;?><?php echo ikurl('message','do',array('ik'=>'del','type'=>'inbox','messageid'=>$item['messageid']))?>">删除</a>
                  </td>
                </tr>
                <?php }?>
                <tr>
