...
<div>
    无法上传？<a href="<?php echo SITE_URL;?><?php echo ikurl('site','photos',array('ik'=>'baseupload','photosid'=>$photosid))?>">使用普通方式上传照片 &gt;</a>
</div>

<script type="text/javascript">
    var loadurl = "<?php echo SITE_URL;?><?php echo ikurl('site','photos',array('ik'=>'addphoto',photosid=>$photosid))?>";
	var objdata = {'userid': '<?php echo $IK_USER['user'][userid];?>','photosid': '<?php echo $photosid;?>'};
	var jumpurl = "<?php echo SITE_URL;?><?php echo ikurl('site','photos',array('ik'=>'complete',photosid=>$photosid,'addtime'=>$addtime))?>";
