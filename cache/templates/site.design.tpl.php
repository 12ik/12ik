...
<div class="bd">
        ...
        <ul class="list-s sys-bg-list">
            ...
            <li id="bg-1" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/1/thumbnail.png" <?php if($strTheme['theme_id']==1) { ?> class="selected" <?php } ?>></li>
            <li id="bg-2" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/2/thumbnail.png" <?php if($strTheme['theme_id']==2) { ?> class="selected" <?php } ?>></li>
            <li id="bg-3" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/3/thumbnail.png" <?php if($strTheme['theme_id']==3) { ?> class="selected" <?php } ?>></li>
            <li id="bg-4" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/4/thumbnail.png" <?php if($strTheme['theme_id']==4) { ?> class="selected" <?php } ?>></li>
            <li id="bg-5" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/5/thumbnail.png" <?php if($strTheme['theme_id']==5) { ?> class="selected" <?php } ?>></li>            
            <li id="bg-6" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/6/thumbnail.png" <?php if($strTheme['theme_id']==6) { ?> class="selected" <?php } ?>></li>
            <li id="bg-7" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/7/thumbnail.png" <?php if($strTheme['theme_id']==7) { ?> class="selected" <?php } ?>></li>
            <li id="bg-8" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/8/thumbnail.png" <?php if($strTheme['theme_id']==8) { ?> class="selected" <?php } ?>></li>
            <li id="bg-9" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/9/thumbnail.png" <?php if($strTheme['theme_id']==9) { ?> class="selected" <?php } ?>></li>            
            <li id="bg-10" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/10/thumbnail.png" <?php if($strTheme['theme_id']==10) { ?> class="selected" <?php } ?>></li>
            <li id="bg-11" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/11/thumbnail.png" <?php if($strTheme['theme_id']==11) { ?> class="selected" <?php } ?>></li>
            <li id="bg-12" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/12/thumbnail.png" <?php if($strTheme['theme_id']==12) { ?> class="selected" <?php } ?>></li>            
            <li id="bg-13" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/13/thumbnail.png" <?php if($strTheme['theme_id']==13) { ?> class="selected" <?php } ?>></li>            
            <li id="bg-14" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/14/thumbnail.png" <?php if($strTheme['theme_id']==14) { ?> class="selected" <?php } ?>></li> 
            <li id="bg-15" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/15/thumbnail.png" <?php if($strTheme['theme_id']==15) { ?> class="selected" <?php } ?>></li>             
            <li id="bg-16" ><img alt="" src="<?php echo SITE_URL;?>app/site/pics/site/theme/16/thumbnail.png" <?php if($strTheme['theme_id']==16) { ?> class="selected" <?php } ?>></li>             
        ...
        <div class="sp-design-opt">
            ...
            action="<?php echo SITE_URL;?><?php echo ikurl('site','custom',array('ik'=>'background','siteid'=>$strSite['siteid']))?>" id="bg-upload-form" target="iframe-post-form">
            	<div style="display:none;"><input type="hidden" value="<?php echo $strTheme['ck'];?>" name="ck">
                <input type="hidden" value="<?php echo $strTheme['background_ver'];?>" name="ver"></div>
    ...
    <span title="应用背景图" class="sp-bg-show selected">
		<?php if($strTheme['background_image']) { ?>
        <img src="uploadfile/site/custom/theme/<?php echo $strTheme['background_ver'];?>/<?php echo $strTheme['background_image'];?>?ver=<?php echo $strTheme['background_ver'];?>" class="sys-bg" bgimg="<?php echo $strTheme['background_image'];?>" bgpath="<?php echo $strTheme['background_path'];?>">
        <?php } ?>
        <?php if($strTheme['theme_id']!=0) { ?>
        <img src="<?php echo SITE_URL;?>app/site/pics/site/theme/<?php echo $strTheme['theme_id'];?>/thumbnail.png" class="sys-bg" bgimg="" bgpath="">
        <?php } ?>
    </span>
    <?php } else { ?>
    ...
    <?php } ?>
                    ...
                    <div class="sp-bg-sel">
                        ...
                        <br>
                        <input type="checkbox" id="sp-bg-repeat" <?php if($strTheme['background_repeat']=='repeat') { ?>checked="checked"<?php } ?>>
...
<script>
IK.add('colorpicker-css', {path: '<?php echo SITE_URL;?>public/js/colorpicker/css/colorpicker.css', type: 'css'});
IK.add('colorpicker', {path: '<?php echo SITE_URL;?>public/js/colorpicker/js/colorpicker.js', type: 'js', requires: ['colorpicker-css']});
	 ...
	 var 	self,
       ...
       oColorSelector.ColorPicker({
        ...
        oSubmit.click(function (e) {
            ...
            // 开始保存
            $.post_withck(
                siteUrl+'index.php?app=site&ac=custom&ik=savetheme&siteid=' + siteId ,
                {
                    'theme_id': sysThemeId,
