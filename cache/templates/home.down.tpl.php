...
<div class="cleft">
    <div class="infocontent">
    	<h2>最新版本12IK-V1.2下载：<font color="#CCCCCC">已被下载（<?php echo $countdown;?>）次</font></h2>
        ...
        <p>下载地址1：<a href="<?php echo SITE_URL;?><?php echo ikurl('home','down',array('id'=>'2'))?>" target="_blank">在本站下载</a></p>
        <p>下载地址2：<a href="<?php echo SITE_URL;?><?php echo ikurl('home','down',array('id'=>'3'))?>" target="_blank">在Github站下载</a></p>
