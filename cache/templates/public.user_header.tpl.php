...
<div class="pic">
<a href="<?php echo U('hi','',array('id'=>$strUser['doname']))?>">
...
<ul>
	<li><a href="<?php echo U('note','list',array('userid'=>$strUser['userid']))?>">日志</a></li>
    ...
    <li><a href="<?php echo U('message','ikmail',array(ik=>inbox))?>">站内信</a></li>
    <li><a href="<?php echo U('user','set',array(ik=>base))?>">设置</a></li>
    <?php } ?>
</ul>
