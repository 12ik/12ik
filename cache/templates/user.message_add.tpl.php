...
<div class="midder">
  <div class="mc">
    <h1>发送短消息</h1>
    <form method="POST" action="<?php echo SITE_URL;?><?php echo ikurl('user','message',array('ik'=>'message_add_do'))?>">
      <table class="table_1" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td>
            ...
            <input type="submit" value="好了，发送" class="submit" />&nbsp;&nbsp;<a href="<?php echo SITE_URL;?><?php echo ikurl('message','ikmail',array('ik'=>'inbox'))?>">取消</a>
            </td>
        </tr>
      </table>
    </form>
