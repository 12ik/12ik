...
<div class="top_nav">
  <div class="top_bd">
    ...
    <div class="top_info">
        ...
        <?php } else { ?>
        <a id="newmsg" href="<?php echo SITE_URL;?><?php echo tsurl('message','ikmail',array(ts=>inbox))?>"></a> | 
        <?php $globalUser = aac('user')->getOneUser($IK_USER['user'][userid]);?>
        <a href="<?php echo SITE_URL;?><?php echo tsurl('hi','',array('id'=>$globalUser['doname']))?>">
        <?php echo $globalUser['username'];?>
        </a> | 
        <a href="<?php echo SITE_URL;?><?php echo tsurl('user','set',array(ts=>base))?>">设置</a> | 
    ...
    <div class="top_items">
        <ul>
                ...
                <li>
                <a href="<?php echo SITE_URL;?><?php echo tsurl('location')?>">同城</a>
                </li>
                <li>
                <a href="<?php echo SITE_URL;?><?php echo tsurl('group')?>">小组</a>
                </li>
                <li>
	...
	<div class="site_nav">
		...
		<div class="appnav">
            <ul id="nav_bar">
                ...
                <li><a href="<?php echo SITE_URL;?><?php echo tsurl('feed')?>">友邻广播</a></li>
