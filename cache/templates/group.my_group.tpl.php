    ...
    <div class="mc">
        ...
        <div class="cleft">
            ...
            <?php foreach((array)$arrTopic as $key=>$item) {?>
                            <tr class="pl">
                                <td><a title="<?php echo $item['title'];?>" href="<?php echo SITE_URL;?><?php echo tsurl('group','topic',array('id'=>$item['topicid']))?>"><?php echo $item['title'];?></a>
            <?php if($item['istop']=='1') { ?>
            ...
            <?php } ?></td>
                                <td nowrap="nowrap"><a href="<?php echo SITE_URL;?><?php echo tsurl('group','show',array('id'=>$item['groupid']))?>"><?php echo $item['group'][groupname];?></a></td>
        ...
        <div class="cright" id="cright">
                ...
                <div class="bd">
                   <form method="GET" action="<?php echo SITE_URL;?>index.php" id="searchApp">
                    ...
                    <script>
						...
						{
							if(value=='group')						
						    { $('#searchApp').append('<input type="hidden" name="ts" value="group" />'); }
							else
							{ $('#searchApp').append('<input type="hidden" name="ts" value="topic" />'); }
            ...
            <dl class="ob">
            <dt><a href="<?php echo SITE_URL;?><?php echo tsurl('group','show',array('id'=>$item['groupid']))?>"><img alt="<?php echo $item['groupname'];?>" class="m_sub_img" src="<?php echo $item['icon_48'];?>" width="48" /></a></dt>
            <dd><a href="<?php echo SITE_URL;?><?php echo tsurl('group','show',array('id'=>$item['groupid']))?>"><?php echo $item['groupname'];?></a> <span>(<?php echo $item['count_user'];?>)</span></dd>
            </dl>
            <?php }?>
            </div>
            ...
            <p class="pl2">&gt; <a href="<?php echo SITE_URL;?><?php echo tsurl('group','create')?>">创建小组</a></p>
            <?php } ?>
            
            <p class="pl2">&gt; <a href="<?php echo SITE_URL;?><?php echo tsurl('group','all')?>">全部小组</a></p>
