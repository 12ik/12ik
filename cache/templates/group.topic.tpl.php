  ...
  <div class="mc">
    ...
    <div class="cleft"> 
      ...
      <div class="topic-content clearfix">
        <div class="user-face"> <a href="<?php echo SITE_URL;?><?php echo ikurl('hi','',array('id'=>$strTopic['user'][doname]))?>"><img title="<?php echo $strTopic['user'][username];?>" alt="<?php echo $strTopic['user'][username];?>" src="<?php echo $strTopic['user'][face];?>" width="48"></a> <br />
          <?php doAction('topic_face_footer',$strTopic)?> </div>
        <div class="topic-doc">
          <h3> <span class="color-green"><?php echo date('Y-m-d H:i:s',$strTopic['addtime'])?></span> <span class="pl20">来自：<a href="<?php echo SITE_URL;?><?php echo ikurl('hi','',array('id'=>$strTopic['user'][doname]))?>"><?php echo $strTopic['user'][username];?></a></span> </h3>
          ...
          <div style="text-align:right;"> 
            ...
            &gt;&nbsp; <a href="<?php echo SITE_URL;?>index.php?app=group&ac=do&ik=topic_istop&topicid=<?php echo $strTopic['topicid'];?>"><?php if($strTopic['istop']=='0') { ?>置顶<?php } else { ?>取消置顶<?php } ?></a> &gt;&nbsp; <a href="<?php echo SITE_URL;?>index.php?app=group&ac=do&ik=isposts&topicid=<?php echo $strTopic['topicid'];?>"><?php if($strTopic['isposts']==0) { ?>精华<?php } else { ?>取消精华<?php } ?></a> &gt;&nbsp; <a href="<?php echo SITE_URL;?>index.php?app=group&ac=do&ik=topic_isshow&topicid=<?php echo $strTopic['topicid'];?>"><?php if($strTopic['isshow']=='0') { ?>隐藏<?php } else { ?>显示<?php } ?></a> &gt;&nbsp; <a href="<?php echo SITE_URL;?>index.php?app=group&ac=topic_move&groupid=<?php echo $strGroup['groupid'];?>&topicid=<?php echo $strTopic['topicid'];?>">移动</a> 
            
            <?php } ?> 
            &gt;&nbsp; <a href="<?php echo SITE_URL;?>index.php?app=group&ac=topic_edit&topicid=<?php echo $strTopic['topicid'];?>">编辑</a> &gt;&nbsp; <a  href="<?php echo SITE_URL;?>index.php?app=group&ac=do&ik=deltopic&topicid=<?php echo $strTopic['topicid'];?>" onclick="return confirm('确定删除?')">删除</a> </div>
          <?php } ?> 
        </div>
      </div>
      <?php if($IK_USER['user']) { ?>
      	<div class="sns-bar">
        	<div class="sns-bar-rec">
                <span class="rec">
                    <a class="bn-sharing  i a_share_btn" data-pic="<?php echo $strTopic['content_photo'][0];?>" data-title="<?php echo $strTopic['title'];?>" data-desc="<?php echo getsubstrutf8(t($strTopic['content']),0,150)?>" data-url="<?php echo SITE_URL;?><?php echo ikurl('group','topic',array('id'=>$strTopic['topicid']))?>" href="#">分享到</a> &nbsp;&nbsp;
                </span>            
            	<div class="rec-sec"><a href="<?php echo SITE_URL;?><?php echo ikurl('group','do',array('ik'=>'topic_recommend'))?>" title="推荐" class="lnk-sharing i a_recommend_btn"  data-title="<?php echo getsubstrutf8(t($strTopic['title']),0,40)?>"  data-desc="<?php echo getsubstrutf8(t($strTopic['content']),0,100)?>"  data-tkind="<?php echo $strTopic['groupid'];?>" data-tid="<?php echo $strTopic['topicid'];?>" data-tuid="<?php echo $IK_USER['user']['userid'];?>" data-url="<?php echo SITE_URL;?><?php echo ikurl('group','topic',array('id'=>$strTopic['topicid']))?>">推荐</a> <span class="rec-num" id="rec-num"><?php echo $recommendNum;?>人</span></div>
            </div>
            <div class="sns-bar-fav">
            	<span  class="fav-num"><a href="#" id="like-num"><?php echo $collectNum;?>人</a> 喜欢 </span>
            	<?php if($is_Like) { ?>
                <a href="<?php echo SITE_URL;?><?php echo ikurl('group','do',array('ik'=>'topic_collect'))?>" title="取消喜欢" data-tkind="<?php echo $strTopic['groupid'];?>" data-tid="<?php echo $strTopic['topicid'];?>" data-tuid="<?php echo $IK_USER['user']['userid'];?>" class="btn-fav fav-cancel i a_like_btn">喜欢</a> 
				<?php } else { ?>
                <a href="<?php echo SITE_URL;?><?php echo ikurl('group','do',array('ik'=>'topic_collect'))?>" title="标为喜欢" data-tkind="<?php echo $strTopic['groupid'];?>" data-tid="<?php echo $strTopic['topicid'];?>" data-tuid="<?php echo $IK_USER['user']['userid'];?>" class="btn-fav fav-add i a_like_btn">喜欢</a> 
            	<?php } ?>
            </div>        
        </div>
      <?php } ?>
      ...
      <div class="tags"> 
        ...
        <a rel="tag" title="" class="post-tag" href="<?php echo SITE_URL;?><?php echo ikurl('group','topic_tag',array(tagname=>$item['tagname']))?>"><?php echo $item['tagname'];?></a> 
        <?php }?> 
        <?php if($isGroupUser) { ?> 
      ...
      <div class="clear"></div>
      <div> <?php if($upTopic) { ?>上一篇：<a href="<?php echo SITE_URL;?><?php echo ikurl('group','topic',array('id'=>$upTopic['topicid']))?>"><?php echo $upTopic['title'];?></a><?php } ?>
        
        <?php if($downTopic) { ?>下一篇：<a href="<?php echo SITE_URL;?><?php echo ikurl('group','topic',array('id'=>$downTopic['topicid']))?>"><?php echo $downTopic['title'];?></a><?php } ?> </div>
      ...
      <ul class="comment" id="comment">
        ...
        <li class="clearfix">
          <div class="user-face"> <a href="<?php echo SITE_URL;?><?php echo ikurl('hi','',array('id'=>$item['user'][doname]))?>"><img title="<?php echo $item['user'][username];?>" alt="<?php echo $item['user'][username];?>" src="<?php echo $item['user'][face];?>"></a> </div>
          <div class="reply-doc">
            <h4><span class="fr"><?php echo $key+1;?>F</span><a href="<?php echo SITE_URL;?><?php echo ikurl('hi','',array('id'=>$item['user'][doname]))?>"><?php echo $item['user'][username];?></a> <?php echo date('Y-m-d H:i:s',$item['addtime'])?></h4>
            ...
            <div class="group_banned"> 
              ...
              <span><a class="j a_confirm_link" href="<?php echo SITE_URL;?>index.php?app=group&ac=comment&ik=delete&commentid=<?php echo $item['commentid'];?>" rel="nofollow" onclick="return confirm('确定删除?')">删除</a> </span> 
              <?php } ?> 
            </div>
      ...
      <div> 
        ...
        <form method="POST" action="<?php echo SITE_URL;?>index.php?app=group&ac=comment&ik=do" onSubmit="return checkComment('#formMini');" id="formMini" enctype="multipart/form-data">
     ...
     <?php } else { ?>
      ...
      <div class="indent newtopic">
        <ul>
          ...
          <li><a title="<?php echo $item['title'];?>" href="<?php echo SITE_URL;?><?php echo ikurl('group','topic',array('id'=>$item['topicid']))?>"><?php echo $item['title'];?></a> &nbsp; <span class="pl">(<a href="<?php echo SITE_URL;?><?php echo ikurl('hi','',array('id'=>$item['user'][doname]))?>"><?php echo $item['user'][username];?></a>) </span> </li>
          <?php }?>
        </ul>
      </div>
      <div class="clear"></div>
