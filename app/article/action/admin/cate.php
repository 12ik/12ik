...
switch($ik){
	...
	case "list":
		...
		//$url = SITE_URL.'index.php?app=article&a=admin&mg=cate&ik=list&page=';
		//$lstart = $page*10-10;
	...
	case "add_do":
		...
		qiMsg("添加成功",'返回到列表',SITE_URL.'index.php?app=article&a=admin&mg=cate&ik=list&nameid='.$nameid);
	...
	case "edit_do":
		...
		qiMsg("添加成功",'返回到列表',SITE_URL.'index.php?app=article&a=admin&mg=cate&ik=list&nameid='.$type);
