...
var cateOptions = {
		...
		addPost : function()
		{
			var url = siteUrl+'index.php?app=note&a=cate_ajax&ik=add';
		...
		{
			var url = siteUrl+'index.php?app=note&a=cate_ajax&ik=update';
...
function recomment(rid,tid){
	...
	var url = siteUrl+'index.php?app=note&a=comment&ik=recomment';
