...
switch ($kind) {
	case "bulletin" :
		...
		$updateUrl = SITE_URL.U('site','bulletin',array('ik'=>'update','bulletinid'=>$bulletinid));
		$settingUrl = SITE_URL.U('site','bulletin',array('ik'=>'settings','bulletinid'=>$bulletinid));
	...
	case "notes" :
		...
		$listUrl    = SITE_URL.U('site','notes',array('ik'=>'list','siteid'=>$siteid,'notesid'=>$notesid));		
		$createUrl  = SITE_URL.U('site','notes',array('ik'=>'create','siteid'=>$siteid,'notesid'=>$notesid));
		$settingUrl = SITE_URL.U('site','notes',array('ik'=>'settings','siteid'=>$siteid,'notesid'=>$notesid));
	...
	case "forum":
		...
		$listUrl    = SITE_URL.U('site','forum',array('ik'=>'list','forumid'=>$forumid));		
		$createUrl  = SITE_URL.U('site','forum',array('ik'=>'create','forumid'=>$forumid));
		$settingUrl = SITE_URL.U('site','forum',array('ik'=>'settings','forumid'=>$forumid));
	...
	case "photos":
		...
		$listUrl    = SITE_URL.U('site','photos',array('ik'=>'list','photosid'=>$photosid));		
		$createUrl  = SITE_URL.U('site','photos',array('ik'=>'upload','photosid'=>$photosid));
		$settingUrl = SITE_URL.U('site','photos',array('ik'=>'settings','photosid'=>$photosid));
