...
{
	//发往对方
	if($arrMessages['isoutbox']==1){ header("Location: ".SITE_URL.U('message','ikmail',array('ik'=>'inbox')));  }
...
{
	//接收的信息
	if($arrMessages['isinbox']==1){ header("Location: ".SITE_URL.U('message','ikmail',array('ik'=>'inbox')));  }
