...
class SimpleCaptcha {
    public $width  = 120;
    public $height = 50;
	public $glbVerifySeed = "abcdefghigklmnopqrstuvwxyz";
	public $strLength = 5;
    ...
    protected function WriteText($text) {
        ...
        for ($i=0; $i<$length; $i++) {
            ...
            $coords = imagettftext($this->im, $fontsize, $degree,$x, $y,$this->GdFgColor, $fontcfg['font'], $letter);
			 //imagettftext($this->im, 20, 0, 10, 20, $this->GdFgColor, $fontcfg['font'], $letter);
